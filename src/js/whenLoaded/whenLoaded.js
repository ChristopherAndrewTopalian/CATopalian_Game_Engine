...
function whenLoaded()
{
    ...
    makeTreasure('treasureCopper', 'src/media/textures/copper.jpg', 20000, 80);

    // whichId, whichSrc, whichX, whichY
    makeTreasure('treasureSilver', 'src/media/textures/silver.jpg', 40000, 100);
    ...
    makeTilesOneRow("src/media/textures/asphalt.jpg", 10, 0, 0, 500, 500);

    makeTilesOneRow("src/media/textures/asphalt.jpg", 10, 0, 500, 500, 500);

    makeTilesOneRow("src/media/textures/asphalt.jpg", 10, 0, 1000, 500, 500);

    // here is a much easier way to make a tiled background with rows and columns specified
    makeTiles(
        "src/media/textures/wood_003.jpg", // url
        12,         // rows
        4,           // columns
        120,       // xPos
        2780,     // yPos
